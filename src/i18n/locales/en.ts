export default {
  ...
  nav: {
    printers: 'Trang chủ',
    operationPlan: 'Kế hoạch vận hành',
    stations: 'Trạm quan trắc',
    map: 'Bản đồ trạm & Thời tiết',
    alerts: 'Thiết lập cảnh báo',
    interpolationTables: 'Bảng nội suy',
    calculatedValues: 'Giá trị tính toán',
    dataTransmission: 'Truyền dữ liệu',
    reports: 'Báo cáo',
    reportsLegal: 'Báo cáo pháp lý',
    reportsDataTable: 'Báo cáo phát điện',
    reportsSensorData: 'Số liệu quan trắc',
